...
function globals:load_variable()
    ...
    self.plugin_dir = vim.fn.stdpath("data") .. path_sep .. "plugins"
    self.treesitter_dir = vim.fn.stdpath("data") .. path_sep .. "treesitter"
    self.local_plugin_dir = vim.fn.stdpath("data") .. path_sep .. "local_plugins"
