...
vim.cmd([[command! FormatDisable lua require'modules.lsp.formatting'.formatToggle(true)]])
vim.cmd([[command! FormatEnable lua require'modules.lsp.formatting'.formatToggle(false)]])
