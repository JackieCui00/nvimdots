require("modules.lsp.formatting")
...
local function custom_attach(client)
    ...
    if client.server_capabilities.document_formatting then
        ...
        vim.cmd([[autocmd BufWritePost <buffer> lua require'modules.lsp.formatting'.format()]])
        vim.cmd([[augroup END]])
    end
end
...
-- local rustfmt = require("modules.lsp.efm.formatters.rustfmt")
